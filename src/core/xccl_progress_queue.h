...
typedef struct progress_queue_api{
    xccl_status_t (*progress_queue_enqueue)(xccl_progress_queue_t*, xccl_coll_task_t*);
...
xccl_status_t xccl_task_enqueue(xccl_progress_queue_t *q, xccl_coll_task_t *task);
