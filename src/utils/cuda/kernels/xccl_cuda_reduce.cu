...
#define DO_CUDA_REDUCE_WITH_OP(NAME, OP)                                     \
template <typename T>                                                        \
__global__ void XCCL_REDUCE_CUDA_ ## NAME (T *s1, T *s2, T *t, size_t count) \
{                                                                            \
...
DO_CUDA_REDUCE_WITH_OP(MAX,  DO_OP_MAX)
DO_CUDA_REDUCE_WITH_OP(MIN,  DO_OP_MIN)
DO_CUDA_REDUCE_WITH_OP(SUM,  DO_OP_SUM)
DO_CUDA_REDUCE_WITH_OP(PROD, DO_OP_PROD)
DO_CUDA_REDUCE_WITH_OP(LAND, DO_OP_LAND)
DO_CUDA_REDUCE_WITH_OP(BAND, DO_OP_BAND)
DO_CUDA_REDUCE_WITH_OP(LOR,  DO_OP_LOR)
DO_CUDA_REDUCE_WITH_OP(BOR,  DO_OP_BOR)
